...
1. Find or Create an Issue
   - **Find Existing Issue:**
     - Navigate to the Issues section to see open tasks.
...
3. Work on the Issue
   ...
   - **Test everything you do** to ensure it works as expected.

4. Commit and Push
   - Make frequent commits with descriptive messages (I like to use gitmoji), and then push to your PR on GitHub.
